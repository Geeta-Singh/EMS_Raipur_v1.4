    ...
    * */
    public void Login(View view) {
        if (isConnected()) {
            ...
            try {
                ...
                if(check(user,pwd)) {
                    ...
                    if (language .equalsIgnoreCase( "hi") ){
                        progressDialog = ProgressDialog.show(Login.this, "", "कृपया प्रतीक्षा करें .", true);
                    }
                    else
                    ...
                    Snackbar snackbar;
                    snackbar = Snackbar.make(getCurrentFocus(),R.string.mendatory, Snackbar.LENGTH_LONG);
            ...
            Snackbar snackbar;
            snackbar = Snackbar.make(view,R.string.internet, Snackbar.LENGTH_LONG);
            snackbar.show();
    ...
    public void cancelRelogin(View view){
        Runtime.getRuntime().gc();
        System.gc();
        card.setVisibility(View.INVISIBLE);
        relogin.setVisibility(View.INVISIBLE);
       ...
       // onPostExecute displays the results of the AsyncTask.
        ...
        protected void onPostExecute(String status) {
            ...
            if(status.equalsIgnoreCase("Unauthorized")){
                Snackbar snackbar;
                 snackbar = Snackbar.make(getCurrentFocus(),R.string.usernamepassword, Snackbar.LENGTH_LONG);
                View snackBarView = snackbar.getView();
                snackBarView.setBackgroundColor(Color.argb(255, 48, 59, 68));
                snackbar.show();
                progressDialog.dismiss();
                ...
                Snackbar snackbar;
                snackbar = Snackbar.make(getCurrentFocus(),R.string.internet, Snackbar.LENGTH_LONG);
                snackbar.show();
                progressDialog.dismiss();
            }
                ...
                Snackbar snackbar;
                snackbar = Snackbar.make(getCurrentFocus(),R.string.OTpResult, Snackbar.LENGTH_LONG);
                snackbar.show();
    ...
    private class HttpAsyncTaskRelogin extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String status) {
            ...
            if(status.equalsIgnoreCase("Unauthorized")){
                ...
                Snackbar snackbar;
                snackbar = Snackbar.make(getCurrentFocus(),R.string.InvalidOTP, Snackbar.LENGTH_LONG);
                View snackBarView = snackbar.getView();
                snackBarView.setBackgroundColor(Color.argb(255, 48, 59, 68));
                snackbar.show();
                progressDialog.dismiss();
        ...
        protected void onPostExecute(String status) {
            ...
            try {
                ...
                if (status.equalsIgnoreCase("Error : Few parameters are missing")) {
                    ...
                    Snackbar snackbar;
                    //Initializing snackbar using Snacbar.make() method
                    snackbar = Snackbar.make(getCurrentFocus(),R.string.Nodata, Snackbar.LENGTH_LONG);
                    View snackBarView = snackbar.getView();
                    snackBarView.setBackgroundColor(Color.argb(255, 48, 59, 68));
                    //Displaying the snackbar using the show method()
                    snackbar.show();
    ...
    private void addListItemToSession(String status) {
        ...
        try {
         ...
         //   System.out.println("inside device@@@@ condition" +status);
            ...
            System.out.print("  ts in device condition  "+job.get("ts"));
           // System.out.p
