...
public class TabFragment extends Fragment {
   // static ProgressDialog pdailo=null;
    ...
    private void setupViewPager(final ViewPager viewPager) {
        ...
        System.out.print("\n  language in current "+lang+"\n");
        if(Locale.getDefault().getLanguage().equalsIgnoreCase("hi")){
            System.out.print("\n if of  language in current "+lang+"\n");
            adapter.addFragment(new CurrentFragment(), "नवीनतम डाटा(टेबल )");
            adapter.addFragment(new GraphicalCurrentFragment(), "नवीनतम डाटा(ग्राफ )");
        }
        else{
            System.out.print("\n else of  language in current "+lang+"\n");
