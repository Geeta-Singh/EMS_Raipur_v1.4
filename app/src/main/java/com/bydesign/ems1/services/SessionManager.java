...
public class SessionManager {
        ...
        public static final String KEY_HISTFLAGE="Historyflag";
...
/* ******************************************    session methods for historical data***********************************/
    ...
    public void setFlagForHistory(int flag){
        editor.putInt(KEY_HISTFLAGE,flag);
        editor.commit();
    }
  ...
  /*  public void setdevicehistory(String dev){
   ...
   // public static final String KEY_DEVICE="device";
    ...
    public void addSessionForMap(String map){
        System.out.print(" inside session manager "+map);
    ...
    {//Context context;
      ...
      //  editor.remove("token");
       ...
       /* ComponentName receiver = new ComponentName(contxt, com.bydesign.ems1.AlarmService.class);
